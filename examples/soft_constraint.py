...
# start = pd.Timestamp("2025-11-26T02:00:00+02:00")
start = pd.Timestamp("2026-02-02T02:00:00+02:00")
...
async def main():
    ...
    # client = FlexMeasuresClient(host="ems.seita.energy", ssl=True, email=usr, password=pwd)
